...
#                     print("Monitoring")
#                     engine.say("Monitoring".format(e))
#                     engine.runAndWait()
            ...
            with smtplib.SMTP("smtp.gmail.com", 587) as smtp:
                ...
                subject = 'BatCave Security Breach!!'
                body = 'Your possessions are in danger! Go save them asap!'
        ...
        engine.say("please say good morning post")
        engine.runAndWait()
...
#         engine.say("Good Morning Ashish! Today is May 2nd, 2021 and you are awesome")
        
#         engine.runAndWait()
    except sr.UnknownValueError:
#         engine.say("Google Speech Recognition could not understand audio")
#         engine.runAndWait()
        recog = 'Sorry could you speak again'
        return recog
    except sr.RequestError as e:
#         engine.say("Could not request results from Google Speech Recognition service; {0}".format(e))
#         engine.runAndWait()
